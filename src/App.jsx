...
export default function App() {
  ...
  return (
    ...
    <div className=" flex justify-between items-start mb-16 " >
        ...
        <p className="text-2xl opacity-70 font-semibold">Information about a user, including name, email,start date, inviter, status, and available actions. </p>
        </div>
        <button className="bg-black text-white px-10 py-4 text-2xl font-semibold rounded-md" >Download Report</button>
    </div>
