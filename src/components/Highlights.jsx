...
const Highlights = ({selectedUsers}) => {
    ...
    return (
    <div className="flex gap-8 h-48 mb-16">
      <div className="grow flex items-center p-4 gap-4 2xl:gap-8 border-2 border-black border-opacity-30 bg-white rounded-xl">
        ...
        <div className="flex flex-col gap-4">
            <p className="text-2xl opacity-60 font-semibold " >Total Users</p>
            <p className="text-6xl 2xl:text-7xl font-semibold">{selectedUsers.length}</p>
        </div>
      ...
      <div className="grow flex items-center p-4 gap-4 2xl:gap-8 border-2 border-black border-opacity-30 bg-white rounded-xl">
        ...
        <div className="flex flex-col gap-4">
            <p className="text-2xl opacity-60 font-semibold " >Active Users</p>
            <p className="text-6xl 2xl:text-7xl font-semibold">{activeUsers}</p>
        </div>
        <FaExternalLinkAlt className="h-8 opacity-60 justify-self-end self-start" />
      </div>
      <div className="grow flex items-center p-4 gap-4 2xl:gap-8 border-2 border-black border-opacity-30 bg-white rounded-xl">
        ...
        <div className="flex flex-col gap-4">
            <p className="text-2xl opacity-60 font-semibold " >Inactive Users</p>
            <p className="text-6xl 2xl:text-7xl font-semibold">{inactiveUsers}</p>
        </div>
        <FaExternalLinkAlt className="h-8 opacity-60 justify-self-end self-start" />
      </div>
      <div className="grow flex items-center p-4 gap-4 2xl:gap-8 border-2 border-black border-opacity-30 bg-white rounded-xl">
        ...
        <div className="flex flex-col gap-4">
            <p className="text-2xl opacity-60 font-semibold " >Blocked Users</p>
            <p className="text-6xl 2xl:text-7xl font-semibold">{blockedUsers}</p>
        </div>
